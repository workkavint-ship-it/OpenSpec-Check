...
- id: "core_12_1"
  ...
  extraction_logic: |
    ...
    2. Verify the @json tag is directly adjacent to the 'struct EXTERNAL I...' declaration (no blank lines between)
  verification_logic: |
...
If the prerequisite is not found (e.g. no stored IShell pointer for rule_17), the
